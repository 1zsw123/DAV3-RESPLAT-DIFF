...
from .model.mip_splatting_refiner import MipSplattingRefinerCfg
from .model.diffusion_head import DiffusionHeadCfg
...
class ModelCfg:
    decoder: DecoderCfg
    encoder: EncoderCfg
    refiner: Optional[MipSplattingRefinerCfg] = None
    diffusion_head: Optional[DiffusionHeadCfg] = None
